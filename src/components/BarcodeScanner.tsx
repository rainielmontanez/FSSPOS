...
export const BarcodeScanner: React.FC<BarcodeScannerProps> = ({
  ...
  const [scannerMode, setScannerMode] = useState<'camera' | 'input'>('input');
  ...
  const captureAndScan = () => {
    ...
    const detectedCode = detectBarcodePattern();
    if (detectedCode) {
        ...
        <div className="p-4 sm:p-6">
          ...
          <div className="mt-4 sm:mt-6 p-3 sm:p-4 bg-blue-50 border border-blue-200 rounded-lg">
            ...
            <ul className="text-xs sm:text-sm text-blue-800 space-y-1">
              <li>• <strong>Manual:</strong> Type barcode numbers or use USB scanner</li>
              <li>• <strong>Camera:</strong> Point camera at barcode (demo mode)</li>
              <li>• <strong>USB Scanner:</strong> Use manual mode and scan directly</li>
              <li>• <strong>Mobile:</strong> Manual input recommended for reliability</li>
            </ul>
          </div>
        </div>
      </div>
